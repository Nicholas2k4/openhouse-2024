...
<body class="bg-gray-100 flex justify-center items-center min-h-screen px-4 sm:px-6">
    ...
    <div class="bg-black bg-opacity-50 rounded-lg p-6 shadow-lg max-w-3xl w-full mt-8 mb-8 backdrop-blur">
        <form method="POST" action={{ route('pendaftaran.store') }} onsubmit="disableSubmitButton()">
            @csrf
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-2">
                    <h2 class="sm:text-2xl text-2xl font-bold text-center bg-gradient-to-r from-[#DEC47C] via-[#F7EECF] to-[#DEC47C] text-transparent bg-clip-text mb-5">
                    ...
                    <div class="border-b border-gray-900/10 pb-6">
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                <label for="first-name" class="block max-sm:text-sm font-medium leading-6 text-slate-50">Nama lengkap</label>
                                <div class="mt-2">
                                    <input type="text" value="{{ $name }}" name="name" id="first-name" autocomplete="given-name"
                            ...
                            <div class="sm:col-span-3">
                                <label for="last-name" class="block max-sm:text-sm font-medium leading-6 text-slate-50">NRP</label>
                                <div class="mt-2">
                                    <input type="text" value="{{ $nrp }}" name="nrp" id="last-name" autocomplete="family-name"
                                        class="px-2 bg-[#f7eecf] block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 max-sm:text-sm sm:leading-6"
                                        readonly required>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                <label for="last_name" class="block max-sm:text-sm font-medium leading-6 text-slate-50">ID line</label>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-3">
                                <label for="last_name" class="block max-sm:text-sm font-medium leading-6 text-slate-50">No. Telp</label>
                                <div class="mt-2">
                            ...
                            @if ($ukm_slug == 'ilustrasi')
                                <div class="col-span-full">
                                    <label for="about" class="block max-sm:text-sm font-medium leading-6 text-slate-50">Link google drive (Portfolio)</label>
                                    <div class="mt-2">
                            ...
                            @elseif($ukm_slug == 'vg')
                                <div class="col-span-full">
                                    <label for="about" class="block max-sm:text-sm font-medium leading-6 text-slate-50">Mohon mengisi jadwal seleksi di bawah ini</label>
                                    <div class="mt-2">
                            ...
                            @elseif($ukm_slug == 'esport')
                                <div class="col-span-full">
                                    <label for="about" class="block max-sm:text-sm font-medium leading-6 text-slate-50">Mohon mengisi google form seleksi di bawah ini sesuai cabang e-sport Anda:</label>
                                    <div class="mt-2">
                                        <a class="block max-sm:text-sm font-medium leading-6 text-slate-50"
                                            href="https://forms.gle/vVi1tuWstnvgzUba7"
                                            target="blank">Valorant</a>
                                    </div>
                                    <div class="mt-2">
                                        <a class="block max-sm:text-sm font-medium leading-6 text-slate-50"
                                            href="https://forms.gle/V1wkf3Kng1jxF1C19"
                                            target="blank">Mobile Legends</a>
                                    </div>
                                    <div class="mt-2">
                                        <a class="block max-sm:text-sm font-medium leading-6 text-slate-50"
                                            href="https://docs.google.com/forms/d/1NVeJYBNW-tAEnk5-8VozH35iaiOImc4w8VhJvAwwOcs/edit?ts=66b7753d#responses"
                                            target="blank">Ladies + selain ML & Valorant</a>
                                    </div>
                                </div>
                            @else
                        ...
                        <div class="mt-6 flex items-center justify-end gap-x-6 pt-6">
                            <a href="{{ route('user.home') }}">
                                <button type="button" class="text-sm font-semibold leading-6 text-white">Kembali</button>
                            </a>
