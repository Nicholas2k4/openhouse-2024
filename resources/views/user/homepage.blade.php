...
@section('content')
    ...
    <section class="video w-full xl:h-[100vh] z-50 overflow-hidden flex items-center">
        <video src="{{ asset('assets/Video OH.mp4') }}" autoplay muted loop playsinline class="w-[100vw]"></video>
...
@section('script')
    ...
    <script>
        ...
        const answerArray = [
            ...
            'Tidak, tetapi bagi Mahasiswa Baru yang mengumpulkan “Collectible Quest” akan mendapatkan diskon pendaftaran sejumlah Rp50.000,00/orangnya. Panitia Open House 2024 akan mengumumkan pemenang melalui akun Instagram resmi @openhouse.pcu',
