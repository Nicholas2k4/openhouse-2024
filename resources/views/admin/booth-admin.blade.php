    ...
    @if (session()->has('success'))
        ...
        <div class="h-full flex justify-center px-4">
            <div
                ...
                <p class="text-3xl text-white font-bold text-center mb-2">Input Data Admin Penjaga Booth UKM</p>
                <form id="" action="{{ route('admin.store-admin-booth') }}" method="POST" class="flex flex-col gap-4">
                    ...
                    <input type="text" name="name" placeholder="Nama Lengkap" class="h-12 p-2 border-2 rounded"
                        required>
