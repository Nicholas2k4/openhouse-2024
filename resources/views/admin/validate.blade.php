...
<div class="h-full justify-center px-4">
    ...
    <div class="flex flex-col lg:flex-row p-2">
        ...
        <label for="sort" class="self-start lg:self-center lg:ms-4 me-2">Sort</label>
        <select name="" id="sort" class="border-2 border-gray-200 rounded mb-2 lg:mb-0">
            ...
            <table class="w-full">
                <thead class="bg-gray-200 border-b-2 border-gray-200">
                    <tr class="text-left text-nowrap">
                        ...
                        <th class="p-3 text-md font-bold tracking-wide border-e-2 border-gray-200">Tanggal Bayar</th>
